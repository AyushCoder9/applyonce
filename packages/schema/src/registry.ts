...
export const REGISTRY: readonly FieldDef[] = [
  ...
  f("category.issue_date", "category", "date", "Category certificate issue date", "श्रेणी प्रमाण पत्र जारी तिथि"),
  f("category.valid_until", "category", "date", "Category certificate valid until", "श्रेणी प्रमाण पत्र वैधता", { expires: true }),
