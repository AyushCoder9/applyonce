    ...
    <div className={cx("card flex gap-4 p-4 transition-shadow", href && "hover:shadow-pop")}>
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-ink-2">
          <span className={cx("inline-flex items-center gap-1 rounded-pill px-2 py-0.5", doc.origin === "digilocker" ? "bg-verified-50 text-verified-700" : "bg-surface-2")}><Origin className="size-3.5" />{doc.origin === "digilocker" ? (locale === "hi" ? "जारीकर्ता से" : "Issuer-verified") : doc.origin === "generated" ? "ApplyOnce-generated" : locale === "hi" ? "अपलोड किया" : "Uploaded"}</span>
