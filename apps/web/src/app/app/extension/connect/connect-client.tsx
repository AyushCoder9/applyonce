    ...
    <div className="card max-w-lg p-6 space-y-5">
      ...
      {connectionCode && status !== "connected" && (
        <div className="space-y-2 rounded-md border border-line bg-surface-2 p-4">
          <p className="text-sm text-ink-2">If the extension didn&apos;t pick this up automatically, copy this connection code and paste it into the extension popup&apos;s &quot;Paste connection code&quot; box. Valid until {fmtDate(expiresAt)}.</p>
