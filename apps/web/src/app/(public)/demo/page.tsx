...
export default function Demo() {
  ...
  const STEPS = [
    ["Open the application", portal ? `Open the BTA-JEE 2026 form → "Fill manually". 6 steps, 48 fields, a timer. Give it 20 seconds.` : "Open the BTA-JEE 2026 application from ApplyOnce. The complete hosted journey is enabled on this deployment."],
    ["Apply with ApplyOnce", "Log in as Aarav. The review screen explains eligibility and shows which fields are verified, missing, or editable."],
