...
export default async function QueuesAdmin() {
  ...
  return (
    <>
      ...
      <p className="mt-3 text-xs text-ink-3">Worker: <code>pnpm --filter @applyonce/worker dev</code>. Failed jobs retry 3× with exponential backoff; inspect with Bull Board later if needed.</p>
    </>
  );
}
