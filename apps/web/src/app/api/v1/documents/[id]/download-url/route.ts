...
import { isMockKey, presignGet, storageDriver } from "@/lib/storage";
...
export const GET = handler(async (req, { params }) => {
  ...
  if (storageDriver() === "blob") return ok({ url: `/api/v1/documents/${doc.id}/content`, mock: false, expiresIn: 300 });
