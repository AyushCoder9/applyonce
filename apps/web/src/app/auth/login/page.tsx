  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-bg px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 flex items-center gap-3"><img src="/icon.svg" alt="" className="size-10 rounded-xl" /><div><div className="font-display text-2xl font-bold">Praman</div><div className="text-sm text-ink-2">Verify once. Apply anywhere.</div></div></div>
