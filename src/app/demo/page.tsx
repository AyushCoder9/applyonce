...
function ReceiptStage({ onRestart, onBack }: { onRestart: () => void; onBack: () => void }) {
  ...
  const saveReceipt = () => {
    triggerDownload(new Blob([JSON.stringify({ product: "ApplyOnce", application: "National STEM Entrance 2026", receiptCode: "NSE26-AM-004281", submittedAt: "2026-08-29T20:18:00+05:30", status: "accepted", consentScope: "Exam only" }, null, 2)], { type: "application/json" }), "nse26-am-004281-receipt.json");
    setSaved(true);
  };
